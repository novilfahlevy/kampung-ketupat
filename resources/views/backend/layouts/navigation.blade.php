        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.pengaturan.index')" :active="request()->routeIs('admin.pengaturan.index')">
                        {{ __('Pengaturan') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.pengguna.index')" :active="request()->routeIs('admin.pengguna.index')">
                        {{ __('Pengguna') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.aktifitas')" :active="request()->routeIs('admin.aktifitas')">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('admin.pengguna.edit', 'profil')">
                                {{ __('Edit Profil') }}
                            </x-dropdown-link>
