            ...
            >
                ...
                <div class="grid grid-cols-1 gap-5 mb-5">
                    <div>
                        ...
                        <x-textarea class="block mb-5 mt-1 w-full" name="youtube_url" id="youtube_url">{{ old('youtube_url', $gallery->photo_url) }}</x-textarea>
                        <p class="text-sm">
                    ...
                    <div>
                        ...
                        <x-textarea class="block mb-5 mt-1 w-full" name="description" id="description">{{ old('description', $gallery->description) }}</x-textarea>
                        @error('description')
                        <p class="text-red-800">{{ $message }}</p>
                        @enderror
                    </div>
